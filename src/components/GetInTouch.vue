        ...
        <div class=" bg-fixed bg-cover bg-center py-40"
            ...
            <div class="flex justify-center space-x-24 max-lg:flex-col max-lg:space-x-0 max-lg:p-5 max-lg:space-y-10">
                <div class="flex flex-col space-y-5">
                    <span class="text-white text-xl">YOUR NAME</span>
                    <input class="font-bold border-b-2 border-[#19df7f] bg-transparent placeholder-white text-2xl pb-3"
                        type="name" placeholder="YOUR NAME" name="" id="">
                </div>
                <div class="flex flex-col space-y-5">
                    <span class="text-white text-xl">YOUR EMAIL</span>
                    <input class="font-bold border-b-2 border-[#19df7f] bg-transparent placeholder-white text-2xl pb-3"
                        type="name" placeholder="YOUR EMAIL" name="" id="">
                </div>
                <div class="flex flex-col space-y-5">
                    <span class="text-white text-xl">YOUR PHOME</span>
                    <input class="font-bold border-b-2 border-[#19df7f] bg-transparent placeholder-white text-2xl pb-3"
                        type="name" placeholder="YOUR PHONE" name="" id="">
                </div>
            </div>
            <div class="flex mx-auto mt-6 max-w-6xl max-lg:p-5">
